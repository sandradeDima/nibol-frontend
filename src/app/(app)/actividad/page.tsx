...
export default async function ActivityPageRoute() {
  ...
  return (
    <main className="space-y-6">
      <PageHeader
        description="Una vista consolidada de cambios, avances, evidencias, decisiones y procesos automáticos con el alcance que corresponde a su rol."
        eyebrow="Control y trazabilidad"
        title="Actividad"
      />
      <ActivityPage
        canExport={authorization.permissions.includes("activity.export")}
        canViewTechnical={
